...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/10 17:27:58 by biaroun           #+#    #+#             */
/*   Updated: 2024/06/10 17:30:32 by biaroun          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_file(t_game *game, char *file)
{
	...
	while (++i < NB_DIR)
	{
		if (!game->wall_files[i]
			|| ft_strlen(game->wall_files[i]) <= ft_strlen(XPM))
		{
			ft_putstr_fd(ERROR, 2);
